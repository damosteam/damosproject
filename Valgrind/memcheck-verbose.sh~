...
# Usage: ./memcheck-verbose.sh
# Platform: Linux/Debian
# Script version: 0.0.2.3
# Date last edited: 04/15/2014

scriptVersion="0.0.2.3"
...
# echo 'Note: this script will reference the DamOS programs and utilities by their default build name (defined in their respective makefiles). It is also assumed that all of their executables are in the same working directory of this script.'
...
echo 'Testing for memory leaks in custom the DamOS programs using Valgrind...'
