...
echo "Encrypting contents of directory using tea cipher..."
./loe -v key.txt -c tea -E

# Now decrypt the encrypted files...
echo "Decrypting contents of directory using tea cipher..."
./loe -v key.txt -c tea -D
