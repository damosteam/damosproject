...
echo "Encrypting contents of directory using xtea cipher..."
./loe -v key.txt -c xtea -E

# Now decrypt the encrypted files...
echo "Decrypting contents of directory using xtea cipher..."
./loe -v key.txt -c xtea -D
