...
echo "Encrypting contents of directory using xxtea cipher..."
./loe -v key.txt -c xxtea -E

# Now decrypt the encrypted files...
echo "Decrypting contents of directory using xxtea cipher..."
./loe -v key.txt -c xxtea -D
