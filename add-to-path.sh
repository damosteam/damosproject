...
echo "export PATH=$PATH:/damos-programs/Cipher/:/damos-programs/Client/:/damos-programs/Server/:/damos-programs/KeyLogger/:/damos-programs/LogProcessor/:/damos-programs/MenuReader/" >> ~/.bashrc
