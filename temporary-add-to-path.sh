...
echo -e "${txtred}Temporarily adding custom DamOS programs and utilites to PATH..." ; tput sgr0
...
export PATH=$PATH:/damos-programs/Cipher/:/damos-programs/Client/:/damos-programs/Server/:/damos-programs/KeyLogger/:/damos-programs/LogProcessor/:/damos-programs/MenuReader/
